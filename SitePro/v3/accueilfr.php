...
<div class="content">
  <div class="content-column">
    <p>Je suis un développeur web expérimenté spécialisé dans le développement front-end. Avec une passion pour la création de sites web interactifs et conviviaux, je m'efforce toujours d'apporter des solutions de qualité à mes clients.</p>
    <div class="separation"></div>
    <img class="image-cv" src="ressources/bouche.jpg" alt="">
    <div class="separation"></div>
  ...
  <div class="content-column">
    ...
    <div class="separation"></div>
    <img class="image-cv" src="ressources/neon.jpg" alt="">
    <div class="separation"></div>
  </div>
</div>